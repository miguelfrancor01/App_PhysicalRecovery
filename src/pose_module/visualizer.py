...
"""
Utilities to visualize pose estimation results.

This module draws:
- Keypoints
- Skeleton connections

Compatible with variable number of joints (not only COCO-17).
"""

# -------------------------------
# Skeleton definition (COCO reference)
# -------------------------------
...
def get_body_groups(num_joints):
    """
    Dynamically assign joints to body groups depending
    on how many joints the model returned.
    """
...
# -------------------------------
# Filter skeleton connections
# -------------------------------

def get_valid_connections(num_joints):
    """
    Remove skeleton connections that reference joints
    not present in the current model output.
    """
...
def draw_pose(image, keypoints, scores, threshold=0.3):
    ...
    Args:
        ...
        keypoints: tensor or list of keypoints [[x,y], ...]
        scores: confidence scores
        threshold: minimum score to display joint
    ...
    for group, connections in skeleton.items():
        ...
        for a, b in connections:
            ...
            # 🟢 Seguridad extra contra errores de índice
